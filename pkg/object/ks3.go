...
func (s *ks3) PutWithMeta(ctx context.Context, key string, in io.Reader, meta ObjectMeta, getters ...AttrGetter) error {
	return s.put(ctx, key, in, meta, getters...)
}

func (s *ks3) put(ctx context.Context, key string, in io.Reader, meta ObjectMeta, getters ...AttrGetter) error {
...
func (s *ks3) CreateMultipartUploadWithMeta(ctx context.Context, key string, meta ObjectMeta) (*MultipartUpload, error) {
	return s.createMultipartUpload(ctx, key, meta)
}

func (s *ks3) createMultipartUpload(ctx context.Context, key string, meta ObjectMeta) (*MultipartUpload, error) {
	...
	if meta.ContentType != "" {
		params.ContentType = aws.String(meta.ContentType)
	}
