...
func (s *obsClient) Head(ctx context.Context, key string) (Object, error) {
	...
	return &objWithMeta{
		obj: obj{
			...
			sc:     getOrDefaultScValue(string(r.StorageClass), string(obs.StorageClassStandard)),
			status: r.Restore,
		},
...
func (s *obsClient) PutWithMeta(ctx context.Context, key string, in io.Reader, meta ObjectMeta, getters ...AttrGetter) error {
	return s.put(ctx, key, in, meta, getters...)
}

func (s *obsClient) put(ctx context.Context, key string, in io.Reader, meta ObjectMeta, getters ...AttrGetter) error {
...
func (s *obsClient) CreateMultipartUploadWithMeta(ctx context.Context, key string, meta ObjectMeta) (*MultipartUpload, error) {
	return s.createMultipartUpload(ctx, key, meta)
}

func (s *obsClient) createMultipartUpload(ctx context.Context, key string, meta ObjectMeta) (*MultipartUpload, error) {
