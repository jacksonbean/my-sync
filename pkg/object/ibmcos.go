...
func (s *ibmcos) PutWithMeta(ctx context.Context, key string, in io.Reader, meta ObjectMeta, getters ...AttrGetter) error {
	return s.put(ctx, key, in, meta, getters...)
}

func (s *ibmcos) put(ctx context.Context, key string, in io.Reader, meta ObjectMeta, getters ...AttrGetter) error {
	...
	if meta.Metadata != nil {
		params.SetMetadata(aws.StringMap(meta.Metadata))
	}
	var reqID string
...
func (s *ibmcos) CreateMultipartUploadWithMeta(ctx context.Context, key string, meta ObjectMeta) (*MultipartUpload, error) {
	return s.createMultipartUpload(ctx, key, meta)
}

func (s *ibmcos) createMultipartUpload(ctx context.Context, key string, meta ObjectMeta) (*MultipartUpload, error) {
	...
	if meta.ContentType != "" {
		params.SetContentType(meta.ContentType)
	}
	if meta.Metadata != nil {
		params.SetMetadata(aws.StringMap(meta.Metadata))
	}
