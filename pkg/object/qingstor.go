...
func (q *qingstor) PutWithMeta(ctx context.Context, key string, in io.Reader, meta ObjectMeta, getters ...AttrGetter) error {
	return q.put(ctx, key, in, meta, getters...)
}

func (q *qingstor) put(ctx context.Context, key string, in io.Reader, meta ObjectMeta, getters ...AttrGetter) error {
...
func (q *qingstor) CreateMultipartUpload(ctx context.Context, key string) (*MultipartUpload, error) {
	return q.createMultipartUpload(ctx, key, ObjectMeta{})
}

// CreateMultipartUploadWithMeta creates a multipart upload with metadata.
func (q *qingstor) CreateMultipartUploadWithMeta(ctx context.Context, key string, meta ObjectMeta) (*MultipartUpload, error) {
	return q.createMultipartUpload(ctx, key, meta)
}

func (q *qingstor) createMultipartUpload(ctx context.Context, key string, meta ObjectMeta) (*MultipartUpload, error) {
